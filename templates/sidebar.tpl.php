        ...
        <div id="advice-slider">
            ...
            <div class="advice-slider-item">
                <div class="advice-item">
                    <div class="advice-img"><img src="<?=$uri?>/templates/images/image (3).jpg"></div>
                    <div>
                ...
                <div class="advice-item">
                    <div class="advice-img"><img src="<?=$uri?>/templates/images/image (2).jpg"></div>
                    <div>
                        <div class="advice-name">Блич Краткий сюжет</div>
                        <div class="advice-data">11 декабря 2018, Вторник</div>
                    </div>
                ...
                <div class="advice-item">
                    <div class="advice-img"><img src="<?=$uri?>/templates/images/image (4).jpg"></div>
                    <div>
                        <div class="advice-name">Блич Краткий сюжет</div>
                        <div class="advice-data">11 декабря 2018, Вторник</div>
                    </div>
